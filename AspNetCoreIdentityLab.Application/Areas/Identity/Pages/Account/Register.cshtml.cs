            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (_userManager.Options.SignIn.RequireConfirmedAccount || _userManager.Options.SignIn.RequireConfirmedEmail)
                    {
                        ...
                        {
                            await _emailSender.SendEmailAsync(Input.EmailOrUsername, "Confirm your email",
                            $"Please confirm your account by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
                        }

                        return RedirectToPage("RegisterConfirmation", new { email = Input.EmailOrUsername, confirmationUrl = callbackUrl });
                    }
                    else
                    {
